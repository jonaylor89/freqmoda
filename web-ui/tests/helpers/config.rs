...
impl TestConfigBuilder {
    ...
    pub fn with_openai(mut self, openai: OpenAIConfig) -> Self {
    ...
    pub fn build(self) -> Settings {
        Settings {
            ...
            openai: self.openai.unwrap_or_else(default_test_openai_config),
...
pub fn default_test_openai_config() -> OpenAIConfig {
    OpenAIConfig {
...
pub fn test_settings_with_mock_urls(openai_mock_url: &str, streaming_mock_url: &str) -> Settings {
    let openai = OpenAIConfig {
        api_key: SecretString::from("test-api-key"),
        base_url: openai_mock_url.to_string(),
        model: "gpt-4o".to_string(),
    };
...
mod tests {
    ...
    fn test_mock_urls() {
        ...
        assert_eq!(settings.openai.base_url, claude_url);
