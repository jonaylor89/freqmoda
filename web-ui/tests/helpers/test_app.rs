...
impl TestApp {
    ...
    pub async fn new_with_config(config_builder: TestConfigBuilder) -> Self {
        ...
        settings.openai.base_url = mocks.get_openai_base_url();
    ...
    pub async fn setup_openai_success(&self) {
        self.mocks.openai_mock.mock_chat_completion_success().await;
    }

    pub async fn setup_openai_error(&self, status_code: u16, error_message: &str) {
        self.mocks
            .openai_mock
    ...
    pub async fn setup_openai_text_response(&self, response_text: &str) {
        self.mocks
            .openai_mock
    ...
    pub async fn verify_openai_request_count(&self, expected_count: u64) -> bool {
        self.mocks
            .openai_mock
    ...
    pub async fn get_last_openai_request(&self) -> Option<wiremock::Request> {
        self.mocks.openai_mock.get_last_request().await
    }
}
...
mod tests {
    ...
    async fn test_app_setup() {
        ...
        assert!(!app.mocks.get_openai_base_url().is_empty());
    ...
    async fn test_mock_setup() {
        ...
        app.setup_openai_text_response("Test response").await;
