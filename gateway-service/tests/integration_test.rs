...
async fn test_configuration_parsing() {
    let settings = Settings {
        ...
        redis: gateway_service::config::RedisConfig {
...
mod chat_tests {
    ...
    async fn test_chat_endpoint_basic_message() {
        ...
        app.setup_claude_text_response("Hello! I'm here to help with audio processing.")
            .await;
    ...
    async fn test_chat_endpoint_with_conversation_id() {
        ...
        app.setup_claude_text_response("I can help you reverse that audio file.")
            .await;
    ...
    async fn test_chat_endpoint_audio_processing_request() {
        ...
        app.setup_claude_success().await;
    ...
    #[tokio::test]
    async fn test_chat_endpoint_claude_error() {
        let app = TestApp::new().await;
        let _test_data = app.seed_test_data().await;

        app.setup_claude_error(500, "Internal server error").await;
    ...
    async fn test_chat_endpoint_conversation_persistence() {
        ...
        app.setup_claude_text_response("First response").await;
        ...
        app.setup_claude_text_response("Second response").await;
...
mod error_handling_tests {
    ...
    async fn test_malformed_json_requests() {
        ...
        let router = gateway_service::routes::create_router(app.state.as_ref().clone());
        let response = router
            .oneshot(request)
            .await
            .expect("Failed to send request");
...
mod performance_tests {
    ...
    async fn test_concurrent_chat_requests() {
        ...
        app.setup_claude_text_response("Concurrent response").await;
...
mod security_tests {
    ...
    async fn test_xss_protection() {
        ...
        app.setup_claude_text_response("Safe response").await;
...
mod edge_case_tests {
    ...
    async fn test_unicode_and_special_characters() {
        ...
        app.setup_claude_text_response("Unicode response: 🎵🤖💬")
            .await;
