    ...
    <div className="min-h-screen bg-gradient-to-br from-[#13111C] to-[#191627] text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#1C1A27]/70 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/5">
          <div className="grid grid-cols-[1fr_auto_auto] gap-12 mb-6 px-4">
            <div className="text-gray-400 font-medium uppercase text-sm tracking-wider">Name</div>
            <div className="text-gray-400 font-medium uppercase text-sm tracking-wider text-center">Duration</div>
          ...
          {tracksData.tracks.map((track) => (
            <div
              key={track.id}
              className="grid grid-cols-[1fr_auto_auto] gap-12 items-center py-5 px-4 hover:bg-white/5 rounded-2xl transition-colors group"
            >
